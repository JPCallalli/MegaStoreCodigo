        ...
        >
          ...
          >
            <a className="flex title-font font-medium items-center md:justify-start justify-center text-white">
              ...
              <span className="ml-3 text-xl">Store Megacode</span>
            </a>
            <p className="mt-2 text-sm text-gray-500">
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Blanditiis assumenda quisquam animi sequi ducimus, fuga sit rem.
            </p>
          </div>
          <div
