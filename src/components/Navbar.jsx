                ...
                <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                  ...
                  <div className="hidden sm:ml-6 sm:block">
                    <div className="flex space-x-4">
                      ...
                      {/* Si el usuario esta logeado segun el AuthContext, muestra el link dek Carrito, este Link deberia ser privado solo si tengo un usuario logeado y sino, no muestra nada */}
                      {user ? (
                        <Link
                          to="/checkout"
                          className="text-gray-300 hover:bg-gray-700 hover:text-white,
                  ...
                  <Menu as="div" className="relative ml-3">
                    ...
                    >
                      <Menu.Items className="absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black ring-opacity-5">
                        <Menu.Item>
                          <span
                            className="bg-gray-100 cursor-pointer ps-1"
